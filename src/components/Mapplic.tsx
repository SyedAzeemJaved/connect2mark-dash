...
import '../mapplic/css/mapplic.css';
import '../mapplic/css/mapplic-style.css';

export function Mapplic() {
    useEffect(() => {
        (function ($) {
            'use strict';
            ...
            var Mapplic = function (element) {
                ...
                self.loc = {
                    more: 'More',
                    search: 'Search',
                    iconfile: './src/mapplic/images/icons.svg',
                };
                ...
                self.init = function (options) {
                    ...
                    if (self.el.data('mapdata')) {
                        ...
                        $.getJSON(self.o.source, function (data) {
                            ...
                            self.el
                                .removeClass('mapplic-loading')
                                .addClass('mapplic-error');
                            alert(
                ...
                function Tooltip() {
                    ...
                    this.init = function (location) {
                        ...
                        $('.mapplic-layer.mapplic-visible', self.map).append(
                            this.el,
                        );
                    ...
                    this.repos = function (e) {
                        ...
                        if (s.el.position().left < s.wrap.outerWidth() / 2) {
                            ...
                            s.el.position().left >
                            self.container.el.outerWidth() -
                                s.wrap.outerWidth() / 2
                        ) {
                            if (
                                s.el.position().left <
                                self.container.el.outerWidth() - 12
                            )
                                tx =
                                    ((self.container.el.outerWidth() -
                                        s.el.position().left) /
                    ...
                    this.show = function (location) {
                        if (location) {
                            ...
                            if (this.pin.length == 0) {
                                ...
                                this.shift =
                                    Math.abs(
                                        parseFloat(this.pin.css('margin-top')),
                                    ) + 20;
                    ...
                    this.hide = function () {
                        ...
                        if (self.o.smartip)
                            self.el.off('positionchanged', this.repos);
                    };
                }
                    ...
                    this.init = function () {
                        ...
                        $(self.map)
                            .on('mouseover', '.mapplic-pin', function () {
                                ...
                                s.pin = $(
                                    '.mapplic-pin[data-location="' + id + '"]',
                                );
                                s.shift =
                                    Math.abs(
                                        parseFloat(s.pin.css('margin-top')),
                                    ) + 20;
                ...
                function Minimap() {
                    ...
                    this.show = function (target) {
                        ...
                        $(
                            '.mapplic-minimap-layer[data-floor="' +
                                target +
                                '"]',
                            this.el,
                        ).show();
                    ...
                    this.update = function (x, y) {
                        ...
                        var width =
                            ...
                            height =
                                ...
                                this.el.height(),
                            top =
                                (-y / self.contentHeight / self.scale) *
                                this.el.height(),
                            left =
                                (-x / self.contentWidth / self.scale) *
                                this.el.width(),
                            right = left + width,
                            bottom = top + height;
                ...
                function Legend() {
                    ...
                    this.toggle = function (group, state) {
                        ...
                        $('*[data-category*="' + group + '"]', self.map).each(
                            function () {
                                ...
                                if (attr == group) $(this).toggle(state);
                                    ...
                                    groups.forEach(function (g) {
                                        if (
                                            $(
                                                '.mapplic-toggle > input[data-group="' +
                                                    g +
                                                    '"]',
                                            )[0].checked
                                        )
                    ...
                    this.newToggle = function (group, title) {
                        ...
                        if (group.toggle == 'true') {
                            toggle = $(
                                '<label class="mapplic-toggle"></label>',
                            );
                ...
                function Sidebar() {
                        ...
                        if (categories) {
                            $.each(categories, function (index, category) {
                                ...
                                if (!(category.hide == 'true')) {
                                    ...
                                    var toggle =
                                        self.legend.newToggle(category);
                    ...
                    this.addLocation = function (location) {
                        ...
                        var link = $('<a></a>')
                            ...
                            .click(function (e) {
                                ...
                                if (
                                    $(window).width() < 668 &&
                                    (location.action || self.o.action) !=
                                        'lightbox'
                                ) {
                                    $('html, body').animate(
                                        {
                                            scrollTop:
                                                self.container.el.offset().top,
                                        },
                                        400,
                                    );
                                }
                    ...
                    this.search = function () {
                        ...
                        if (self.o.highlight) {
                            ...
                            $('.mapplic-highlight', self.map).removeClass(
                                'mapplic-highlight',
                            );
                        }
                    ...
                    this.sort = function () {
                        var s = this,
                            listitems = this.list
                                .children('.mapplic-list-location')
                                .get();
                            ...
                            function (e) {
                                var x =
                                    ...
                                    y =
                                        ...
                                        self.map.height();
                                $('.mapplic-coordinates-x').text(
                                    parseFloat(x).toFixed(4),
                                );
                                $('.mapplic-coordinates-y').text(
                ...
                function Fullscreen() {
                    ...
                    this.init = function () {
                        ...
                        $(document).on('keyup.mapplic', function (e) {
                            if (
                                e.keyCode === 27 &&
                                $('.mapplic-fullscreen')[0]
                            ) {
                                $(
                                    '.mapplic-element.mapplic-fullscreen',
                                ).removeClass('mapplic-fullscreen');
                ...
                function Container() {
                    ...
                    this.revealChild = function (parent) {
                        $(
                            '.mapplic-pin[data-location^=' + parent.id + '-]',
                            self.map,
                        ).addClass('mapplic-revealed');
                        $(
                            '.mapplic-map-image [id^=' + parent.id + '-]',
                            self.map,
                        ).addClass('mapplic-revealed');
                    };

                    this.revealZoom = function (zoom) {
                        $('.mapplic-pin[data-reveal]', self.map).each(
                            function () {
                    ...
                    this.coverAll = function () {
                        $('.mapplic-revealed', self.map).removeClass(
                            'mapplic-revealed',
                        );
                    };
                        ...
                        $('.mapplic-map-image', self.map).on(
                            ...
                            function (e) {
                                ...
                                if (eo.touches.length == 1) {
                                    ...
                                    mouse = {
                                        x: normalizeX(
                                            eo.touches[0].pageX - init1.x,
                                        ),
                                        y: normalizeY(
                                            eo.touches[0].pageY - init1.y,
                                        ),
                                    };
                                    momentumStep();
                                ...
                                // pinch
                                    ...
                                    initD = Math.sqrt(
                                        Math.pow(init1.x - init2.x, 2) +
                                            Math.pow(init1.y - init2.y, 2),
                                    );
                ...
                var processData = function (data) {
                    ...
                    if (levelnr > 1) {
                        self.levels =
                            $('<div></div>').addClass('mapplic-levels');
                ...
                var latlngToPos = function (lat, lng) {
                    var deltaLng = self.data.rightLng - self.data.leftLng,
                        ...
                        mapWidth =
                            ((self.data.mapwidth / deltaLng) * 360) /
                            (2 * Math.PI),
                        mapOffsetY =
                            (mapWidth / 2) *
                            Math.log(
                                (1 + Math.sin(bottomLatDegree)) /
                                    (1 - Math.sin(bottomLatDegree)),
                            );
                    ...
                    return {
                        x:
                            ((lng - self.data.leftLng) *
                                (self.data.mapwidth / deltaLng)) /
                            self.data.mapwidth,
                        y:
                            (self.data.mapheight -
                                ((mapWidth / 2) *
                ...
                var estimatedPosition = function (element) {
                    ...
                    return {
                        x:
                            ((bbox.x + bbox.width / 2) / self.contentWidth) *
                            self.o.maxscale,
                        y:
                            ((bbox.y + bbox.height / 2) / self.contentHeight) *
                            self.o.maxscale,
                ...
                self.switchLevel = function (target) {
                    ...
                    var layer = $(
                        '.mapplic-layer[data-floor="' + target + '"]',
                        self.el,
                    );
                ...
                self.moveTo = function (x, y, s, duration, ry) {
                    ...
                    self.x = normalizeX(
                        self.container.el.width() * 0.5 -
                            self.scale * self.contentWidth * x,
                    );
                    self.y = normalizeY(
                        self.container.el.height() * ry -
                            self.scale * self.contentHeight * y,
                    );
                ...
                self.addLocations = function (locations, levelid) {
                    $.each(locations, function (index, location) {
                        ...
                        if (elem.length > 0) {
                            ...
                            else if (self.o.defaultstyle)
                                elem.addClass(self.o.defaultstyle);
                            location.el = elem;
                        ...
                        if (location.pin.indexOf('hidden') == -1) {
                            ...
                            if (location.reveal)
                                pin.attr('data-reveal', location.reveal).css(
                                    'visibility',
                                    'hidden',
                                );
                            if (location.category) {
                        ...
                        case 'select':
                            if (location.el) {
                                if (location.el.hasClass('mapplic-active')) {
                                    ...
                                    if (location.list)
                                        location.list.removeClass(
                                            'mapplic-active',
                                        );
                                } else {
                                    location.el.addClass('mapplic-active');
                                    if (location.list)
                                        location.list.addClass(
                                            'mapplic-active',
                                        );
                                }
                            }
                ...
                self.zoomLocation = function (loc) {
                    var zoom = loc.zoom
                        ? parseFloat(loc.zoom) / self.o.maxscale
                        : 1;
        ...
        var map = $('#mapplic').mapplic({
            source: 'src/mapplic/map/map.json',
            height: 'auto',
            sidebar: false,
            minimap: true,
            maxscale: 3,
