      ...
      <>
        ...
        <div className="mt-6 flex items-center justify-between rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark px-4 py-3 sm:px-6">
          <div className="sm:flex sm:flex-1 sm:items-center sm:justify-between">
            <div>
              <p className="text-sm text-black dark:text-gray">
                Showing page <span className="font-medium">{pageNumber}</span>{' '}
                of <span className="font-medium">{apiResponse.pages}</span> with{' '}
                <span className="font-medium">{apiResponse.total}</span>{' '}
                record(s)
              </p>
            </div>
            <div>
              ...
              >
                {hasWhichPages.hasPrev && (
                  <button
                    className="relative inline-flex items-center rounded-l-md px-2 py-2 text-body ring-1 ring-inset ring-body hover:bg-gray dark:hover:bg-graydark focus:z-20 focus:outline-offset-0"
                    onClick={() => {
                ...
                {hasWhichPages.hasNext && (
                  <button
                    className="relative inline-flex items-center rounded-r-md px-2 py-2 text-body ring-1 ring-inset ring-body hover:bg-gray dark:hover:bg-graydark focus:z-20 focus:outline-offset-0"
                    onClick={() => {
