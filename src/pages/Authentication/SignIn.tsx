...
const SignIn = () => {
  const { setLoading, setUser } = useContext(AuthContext) as UserContextProps;
  ...
  const handleClick = async (e: React.MouseEvent) => {
    try {
      ...
      params.append('username', signInData?.email.toLowerCase());
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="2xl:px-20">Connect2Mark - Admin Dashboard</p>
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form>
                ...
                <div className="mt-6 text-center">
                  <p>Please contact your admin if you don't have an account</p>
                </div>
              </form>
            </div>
          </div>
