            ...
            const res = await fetch(constants.ME, {
                ...
                body: JSON.stringify({
                    ...
                    additional_details: {
                        ...
                        phone: nullIfEmpty(
                            currentAdmin.additional_details.phone,
                        ),
                        address: nullIfEmpty(
                            currentAdmin.additional_details.address,
                        ),
        ...
        try {
            ...
            handleUpdate({
                ...
                additional_details: {
                    ...user.additional_details,
                    profilePictureLink:
                        response.additional_details.profile_picture_link,
                },
            });
                                ...
                                <form action="#">
                                    ...
                                    <div className="mb-5.5">
                                        ...
                                        <input
                                            ...
                                            value={
                                                currentAdmin.additional_details
                                                    .phone || undefined
                                            }
                                            onChange={(e) =>
                                                handleChangeadditional_details(
                                                    e,
                                                )
                                            }
                                        />
