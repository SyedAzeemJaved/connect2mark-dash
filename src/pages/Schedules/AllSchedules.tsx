        ...
        (schedule: ScheduleProps) => {
          return {
            ...
            staff_member: {
              ...
              additional_details: {
                phone: schedule.staff_member.additional_details.phone,
                department: schedule.staff_member.additional_details.department,
                designation:
                  schedule.staff_member.additional_details.designation,
              },
            ...
            location: {
              ...
              bluetooth_address: schedule.location.bluetooth_address,
                  ...
                  {AllSchedules.map((schedule) => {
                    return (
                      <tr key={schedule.id}>
                        ...
                        <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                          <p className="text-black dark:text-white">
                            {TimestampConverter(schedule.created_at)}
                          </p>
                        </td>
                        <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                          <p className="text-black dark:text-white">
                            {TimestampConverter(schedule?.updated_at)}
                          </p>
                        </td>
                        <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
