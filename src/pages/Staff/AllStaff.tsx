...
export default function AllStaff() {
  ...
  // const handleManageStudentCourses = (id: number) => {
  //   navigate(`/students/manage/${id}`);
  // };
                      ...
                      <tr key={staff.id}>
                        ...
                        <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                          <p className="text-black dark:text-white">
                            {staff.additional_details?.phone ?? 'Not specified'}
                          </p>
                        </td>
                        <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                          <p className="text-black dark:text-white">
                            {TimestampConverter(staff.created_at)}
                          </p>
                        </td>
                        <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                          <p className="text-black dark:text-white">
                            {TimestampConverter(staff?.updated_at)}
                          </p>
                        </td>
                        <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                          <div className="flex items-center space-x-3.5">
                            ...
                            <button
                              className="hover:text-primary"
                              // onClick={
                              //   // handleManageStudentCourses(staff.id)
                              // }
                            >
                              <svg
