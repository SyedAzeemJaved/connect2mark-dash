            ...
            <form action="#">
              ...
              <div className="mb-5.5">
                ...
                <div className="relative z-20 w-full rounded border border-stroke p-1.5 pr-8 font-medium outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input">
                    ...
                    {currentCourses.map((course) => {
                      return (
                        ...
                        >
                          {course.title}
                          <span
                            className="cursor-pointer pl-2 hover:text-danger z-99"
                            onClick={() => {
                              disAssociateACourse(course.id);
                            }}
                          >
                            <svg
                              width="12"
                  ...
                  >
                    {allCourses.map((course: CourseProps) => {
                      return (
                ...
                <div className="w-full sm:w-1/2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      id="created_at"
                      readOnly
                      value={TimestampConverter(currentStudent.created_at)}
                    />
                  </div>
                </div>
                ...
                <div className="w-full sm:w-1/2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      id="updated_at"
                      readOnly
                      value={TimestampConverter(currentStudent?.updated_at)}
                    />
                  </div>
                </div>
              </div>
